...
struct ProfileRepository {
    let postItems: [PostModel] = [
        PostModel(author: "Vitalii", description: "I am so happy!", image: "1", likes: 3, views: 122, isLiked: false),
        PostModel(author: "Timur", description: "Hello everyone!", image: "2", likes: 33, views: 54, isLiked: false),
        PostModel(author: "Larisa", description: "welcome to my board", image: "3", likes: 23, views: 90, isLiked: false),
        PostModel(author: "Ura", description: "Hahahaah lol", image: "4", likes: 13, views: 13, isLiked: false),
